...
public class task1 {
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("HP", "4", "1000", "Windows", "black");
        Notebook notebook2 = new Notebook("HUAWEI", "16", "512", "Windows", "chromium");
        Notebook notebook3 = new Notebook("Asus", "4", "1000", "Lunex", "chromium");
        Notebook notebook4 = new Notebook("Honor", "16", "512", "Windows", "bleck");
        Notebook notebook5 = new Notebook("Haier", "32", "512", "Windows", "black");
        Notebook notebook6 = new Notebook("HUAWEI", "8", "256", "Windows", "black");
        Notebook notebook7 = new Notebook("ASUS", "8", "512", "Windows", "chromium");
        Notebook notebook8 = new Notebook("Lenovo", "8", "512", "Windows", "black");
        Notebook notebook9 = new Notebook("Xiaomi", "8", "256", "Windows", "black");
        Notebook notebook10 = new Notebook("Xaier", "8", "512", "Windows", "chromium");
        Notebook notebook11 = new Notebook("Haier", "8", "512", "DOS", "black");
        Notebook notebook12 = new Notebook("Honor", "8", "512", "Windows", "black");


        Set<Notebook> notebooks = new HashSet<>(List.of(notebook1, notebook2,
                notebook3, notebook4, notebook5, notebook6, notebook7,
                notebook8, notebook9, notebook10, notebook11, notebook12));
    ...
    public static Map<String, String> selectCriteria() {
        ...
        while (true) {
            System.out.println("Вы хотите выбрать критерий? Если да введите '1', если нет введите '2'");
